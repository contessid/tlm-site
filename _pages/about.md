...
- **Attend a session** — check the [upcoming schedule]({{ '/' | relative_url }}) on the homepage
- **Propose a paper** — suggest topics via our [surveys]({{ '/surveys' | relative_url }}) page
- **Give a talk** — reach out to the organizer if you'd like to present
- **Browse past labs** — see the [Labs]({{ '/labs' | relative_url }}) page for challenges and repositories
